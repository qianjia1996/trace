...
public class CustomPaginationSkin extends BehaviorSkinBase<Pagination, PaginationBehavior> {
...
//        setManaged(false);
    ...
    public void resetIndexes(boolean usePageIndex) {
...
//            }
    ...
    private final DoubleProperty arrowButtonGap = new StyleableDoubleProperty(60.0) {
        ...
        public Object getBean() {
            return CustomPaginationSkin.this;
        }
    ...
    class NavigationControl extends StackPane {
        ...
        public NavigationControl() {
            ...
            leftArrowButton.setText("上一页");
            leftArrowButton.setFont(Font.font(14));
            leftArrowButton.setTextFill(Paint.valueOf("#FFFFFF"));
            leftArrowButton.setGraphicTextGap(0.0);
            ...
            rightArrowButton.setText("下一页");
            rightArrowButton.setFont(Font.font(14));
            rightArrowButton.setTextFill(Paint.valueOf("#FFFFFF"));
            rightArrowButton.setGraphicTextGap(0.0);
...
//            }
            ...
            double controlBoxX = left + PaginationUtils.computeXOffset(width, controlBoxWidth, controlBoxHPos);
            double controlBoxY = top + PaginationUtils.computeYOffset(height, controlBoxHeight, controlBoxVPos);

            if (isPageInformationVisible()) {
                Pos p = sideToPos(getPageInformationAlignment());
                HPos pageInformationHPos = p.getHpos();
                VPos pageInformationVPos = p.getVpos();
                double pageInformationX = left + PaginationUtils.computeXOffset(width, pageInformationWidth, pageInformationHPos);
                double pageInformationY = top + PaginationUtils.computeYOffset(height, pageInformationHeight, pageInformationVPos);
        ...
        private static final CssMetaData<Pagination, Boolean> ARROWS_VISIBLE =
                new CssMetaData<Pagination, Boolean>("-fx-arrows-visible",
                    ...
                    public boolean isSettable(Pagination n) {
                        final CustomPaginationSkin skin = (CustomPaginationSkin) n.getSkin();
